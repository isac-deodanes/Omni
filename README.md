...
proyectos compuesta por una API REST (**omni_api**) y una interfaz web (**omni-frontend**).

## Tabla de contenido

- [Arquitectura general](#arquitectura-general)
- [Tecnologías utilizadas](#tecnologías-utilizadas)
- [omni_api (backend)](#omni_api-backend)
- [omni-frontend (frontend)](#omni-frontend-frontend)
- [Cómo correr el proyecto completo](#cómo-correr-el-proyecto-completo)
...
| [Express 5](https://expressjs.com/) | Framework para definir rutas y manejar peticiones HTTP |
| [MySQL2](https://www.npmjs.com/package/mysql2) | Driver para conectarse a MySQL (usado con `promise` para `async/await`) |
| [dotenv](https://www.npmjs.com/package/dotenv) | Carga de variables de entorno desde `.env` |
| [cors](https://www.npmjs.com/package/cors) | Habilita peticiones cross-origin desde el frontend |
...
| Tecnología | Uso |
|---|---|
| [React 19](https://react.dev/) | Librería para construir la interfaz por componentes |
| [Vite](https://vite.dev/) | Servidor de desarrollo y bundler |
| [ESLint](https://eslint.org/) | Linting y buenas prácticas de código |
...
1. Levantar MySQL localmente y crear la base de datos `OMNI` con sus tablas.
...
|---|---|---|---|
| `POST` | `/api/v1/usuario/crear` | Crea un nuevo usuario | ❌ No |
| `GET` | `/api/v1/usuario/obtener` | Lista los usuarios activos | ✅ Sí |
| `DELETE` | `/api/v1/usuario/eliminar/:id` | Elimina un usuario por `id` | ✅ Sí |
